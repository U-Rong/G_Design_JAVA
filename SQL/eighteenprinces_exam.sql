...
CREATE TABLE `exam` (
  `PrincesNumber` int NOT NULL AUTO_INCREMENT,
  ...
  `IsCleared` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`PrincesNumber`)
...
INSERT INTO `exam` VALUES (1,'後將軍','袁術',8,7,7,5,6,7,5,6,4,9,64,'Defeat'),(2,'廣陵太守','張超',8,9,7,7,9,4,7,7,5,2,65,'Defeat');
